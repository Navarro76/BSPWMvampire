...
# Colores
color_activo="#ffffff"     # blanco para escritorio activo
color_inactivo="#717593"    # Morado coscuro para escritorios sin apps abiertas
color_con_apps="#C2A4F5"     # Morado claro para escritorios con apps abiertas
